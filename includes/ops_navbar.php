...
.sidebar{width:260px;background:#fff;min-height:calc(100vh - 60px);padding:18px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.05)}
...
<div class="navbar-vh">
  <div style="display:flex;align-items:center;gap:12px">
    ...
    <div class="role-badge">Operations Manager</div>
  </div>
